...
public class AttachHelper {
    public static void handle(String jarPath, String pid, String attachOptions)
        ...
        if (pid.equals("list")) {
            ...
            try {
                System.out.println("jarPath=" + null != jarPath ? jarPath : "");
                System.out.println("pid=" + null != pid ? pid : "");
                System.out.println("attachOptions=" + null != attachOptions ? attachOptions : AgentMain.DEFAULT_SECRETS_FILE);
